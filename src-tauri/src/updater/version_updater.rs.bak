...
use crate::browser::browser_version_manager::BrowserVersionManager;
use crate::events;
use crate::updater::auto_updater::AutoUpdater;
...
pub async fn clear_all_version_cache_and_refetch(
  ...
  let api_client = crate::api::api_client::ApiClient::instance();
