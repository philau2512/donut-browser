...
use crate::browser::camoufox::env_vars;
use crate::browser::camoufox::fingerprint::types::*;
use crate::browser::camoufox::fonts;
use crate::browser::camoufox::geolocation;
use crate::browser::camoufox::presets;
use crate::browser::camoufox::webgl;
...
impl CamoufoxConfigBuilder {
  ...
  pub fn build(self) -> Result<CamoufoxLaunchConfig, ConfigError> {
      ...
      presets::get_random_preset(self.operating_system.as_deref(), ff_version)
    {
      ...
      let generator = crate::browser::camoufox::fingerprint::FingerprintGenerator::new()?;
...
pub enum ConfigError {
  ...
  Fingerprint(#[from] crate::browser::camoufox::fingerprint::FingerprintError),
  ...
  Geolocation(#[from] crate::browser::camoufox::geolocation::GeolocationError),
}
