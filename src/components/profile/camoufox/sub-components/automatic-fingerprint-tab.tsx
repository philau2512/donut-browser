...
import type { CamoufoxConfig, CamoufoxOS } from "@/types";

interface AutomaticFingerprintTabProps {
...
export function AutomaticFingerprintTab({
  config,
  onConfigChange,
  selectedOS,
  currentOS,
